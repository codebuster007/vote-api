...
import com.voterapp.voter.vapp.security.CustomUserDetailsService;
...
public class ApiJWTAuthorizationFilter extends BasicAuthenticationFilter {
    ...
    private UsernamePasswordAuthenticationToken getAuthentication(HttpServletRequest request) {
        ...
        if(token != null){
            ...
            CustomUserDetailsService detailsService = (CustomUserDetailsService) SpringApplicationContext.getBean("customUserDetailsService");
            UserDetails userDetails = detailsService.loadUserByUsername(user);

            // Extract Roles Non for now
